...
from app import app
from models import User, Store, Product, Payment, PaymentStatus, Request, db
...
def main():
    with app.app_context():
        ...
        # Seeding users
        merchant_password = bcrypt.generate_password_hash("Merchant1@pass").decode('utf-8')
        users = [
           User(username="Ronnie", name="Ronnie Langat", email="ronnielangat2020@gmail.com", password=bcrypt.generate_password_hash("Admin1@pass").decode('utf-8'), role='admin', image="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png"),
            User(username="Teddy", name="Teddy Maina", email="mainateddy9@gmail.com", password=bcrypt.generate_password_hash("Clerk1@pass").decode('utf-8'), role='clerk', image="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png", store_id=1),
            User(username="Brian", name="Brian Murigi", email="brianmurigi19@gmail.com", password=bcrypt.generate_password_hash("Clerk1@pass").decode('utf-8'), role='clerk', image="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png", store_id=2),
            User(username="vLeyian", name="Victor Leyian", email="leyianv360@gmail.com", password=bcrypt.generate_password_hash("Clerk1@pass").decode('utf-8'), role='clerk', image="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png", store_id=3),
            User(username="Merchant", name="Dave Roy Mutisya", email="myduka7@gmail.com", password=merchant_password, role='merchant', image="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png")
        ]
        db.session.add_all(users)
        db.session.commit()
        
        # Update the ID of the merchant to 5
        merchant = User.query.filter_by(email="myduka7@gmail.com").first()
        if merchant:
            merchant.id = 5
            db.session.commit()
